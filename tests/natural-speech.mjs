...
for(const raw of ['Mason in, Cayden out Q2 4:23','Cayden out, Mason in Q2 4:23','Put Mason in for Cayden Q2 4:23','Mason replaces Cayden Q2 4:23']){const s=fixture(),p=parseCommand(raw,s);assert.deepEqual(compact(p,s).sort((a,b)=>b[0].localeCompare(a[0])),[['PLAYER_OUT',43],['PLAYER_IN',22]],raw);assert(p.events.every(e=>e.clock===263&&e.period===2));}
